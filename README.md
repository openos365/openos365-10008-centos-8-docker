# openos365-10008-centos-8-docker
...
docker run -it openos365/openos365-10008-centos-8-docker-main-root:latest bash
```
#### www

```
docker pull openos365/openos365-10008-centos-8-docker-main-www:latest
docker run -it openos365/openos365-10008-centos-8-docker-main-www:latest bash
```
